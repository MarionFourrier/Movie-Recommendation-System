...
### ESSAI merge :
### Merge left join sur df qu'on retourne dans la fonction : merger les genres de df_title_basics
sortie = pd.merge(result,
                  df_title_basics,
                  how = 'left',
                  left_on = 'tconst',
                  right_on = 'tconst')
sortie = sortie[['title', 'startYear_x', 'averageRating', 'numVotes', 'genres']]
"""